    ...
    return Scaffold(
                          ...
                          onSelected: (String value) {
                            ...
                            if (value == 'kelola-rapor') {
                              ...
                              Get.toNamed(Routes.RAPOR,
                                  arguments: {"idMurid": muridList[index].id, 'semester': 'Semester 1'});
                            } else if (value == 'hapus') {
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                        onPressed: () async {
                                          ...
                                          final muridId = muridList[index].id; // dapatkan ID murid
                                          await FirebaseFirestore.instance
                                              .collection('student')
                                              .doc(muridId) // gunakan ID murid untuk menghapus data
                                              .delete();
                                          Navigator.of(context).pop();
                                        },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Get.toNamed(Routes.ADD_MURID, arguments: controller.idKelasA);
        },
